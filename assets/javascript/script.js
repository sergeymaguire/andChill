  ...
  $.ajax({
    ...
    $.ajax({
      ...
      for (var i = 0; i < response.length; i++) {
        var html = ""
        html = html + "<div class=<p class='name'>" + response[i].name + "</p>" + "<p class='address'>" + response[i].location.address1 + "</p>" + "<p class='phone'>" + response[i].display_phone + "</p>" + "<p class='price'>" + response[i].price + "</p></div>"
